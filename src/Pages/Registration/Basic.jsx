...
function Basic(props) {
	...
	return (
		<div className="basic">
			<div className="brow">
				<input type="text" className="input_field" placeholder={"Full Name"}></input>
				<input className="input_field" placeholder={"Post Applied For"}></input>
			</div>
			<div className="brow">
				<input type="text" className="input_field" placeholder={"Father’s Name"}></input>
			...
			<div className="brow">
				<input type="text" className="input_field" placeholder={"Spouse’s Name"}></input>
				<input className="input_field" placeholder={"Occupation"}></input>
			</div>
			<textarea
				className="text-area"
