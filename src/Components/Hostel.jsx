	...
	return (
		<div>
			<div className="Hostel">
				...
				<div className="Hostel-upper">
					<div className="Hostel-upper-left">
						<p>
							...
							reiciendis incidunt eaque non temporibus aspernatur omnis adipisci,
							saepe dignissimos provident a aliquid perferendis aut impedit id fuga,
							tenetur consequatur officia.
						</p>
					</div>
				...
				<div className="Hostel-Mid-line"></div>
					...
					<div className="Hostel-mid-1">
						...
						<div className="Hostel-mid-1-right">
							<p>
								...
								iusto magnam vitae nam harum officiis? Quisquam earum at illo iste,
								quis minima. Velit magni sed dolorum debitis quae fugit facere.
							</p>
						</div>
					</div>
					<div className="Hostel-mid-2">
						<div className="Hostel-mid-2-left">
							<p>
								...
								corrupti reiciendis id cupiditate saepe repudiandae doloribus
								distinctio quos, iste asperiores enim necessitatibus eveniet sed at.
								Est quidem eum earum tenetur.
							</p>
						</div>
					...
					<div className="Hostel-mid-3">
						...
						<div className="Hostel-mid-3-right">
							<p>
								...
								tenetur quo aliquid dolorem harum repellat cupiditate nobis modi
								mollitia eaque expedita, vel exercitationem atque officia laudantium
								laboriosam voluptatibus voluptatum dolores.
							</p>
						</div>
					</div>
					<div className="Hostel-mid-4">
						<div className="Hostel-mid-4-left">
							<p>
								...
								laborum libero suscipit natus, cumque veritatis quae odio hic
								recusandae illo fugiat nam quia tempore voluptatum cupiditate iusto
								a similique id.
							</p>
						</div>
